  ...
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div className="">
            ...
            <p className="text-gray-400">
              ...
              Molestias minus, assumenda neque eaque maxime similique.
            </p>
          </div>
          <div className="">
            <div className="flex gap-20">
              ...
              <div className="flex-1 md:flex-none">
                ...
                <ul className="list-item space-y-5 text-gray-400">
                  ...
                  <li>
                    <Link href={"#"}>Term & Conditiion</Link>
                  </li>
                  <li>
            ...
            <form action="" className="mt-5">
              <div className="mb-5">
                <input
                  ...
                  placeholder="christianluisginting@gmail.com"
                />
              </div>
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        &copy; {new Date().getFullYear()} Booking Hotel
      </div>
    </footer>
  );
};
